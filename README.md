...
> **当前版本**: v0.7.0 (本地前后端联调与模块化架构收敛)
> **更新日期**: 2026-07-09
> ⚠️ Web版已废弃，相关文档已归档至 `docs/_archive/`

## ⚠️ 重要警告

**部署前必读：**
1. **backend/.env 包含数据库配置和运行密钥，绝对不能提交到Git！**
...
**v0.7.0 新增**
- 🧱 后端按 Identity / Operations / Analysis / MarketData / BoardHeat 上下文收敛
- 🔐 登录加密与安全网关本地联调通过
- 🗄️ 启动时默认预热 Numpy 缓存，首页热点数据可直接加载
- 🖥️ `frontend-client` React SPA 架构收敛，本地前后端联调通过
- 📝 PSDR 记录补齐至本地联调验证结果
...
### 桌面客户端 (v0.4.0+)
- [快速开始指南](docs/client/快速开始指南.md) ⭐️ 客户端开发入门
- [开发文档-客户端加密系统](docs/client/开发文档-客户端加密系统.md) - 加密架构设计
- [技术实现细节](docs/client/技术实现细节.md) - 代码实现参考
