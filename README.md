...
一个基于 FastAPI 和 React 的股票数据分析系统，用于分析股票在多个时间周期内的重复出现情况。

## 🎉 v0.2.0 更新

**模块化重构版本** - 将原有单文件项目重构为标准的模块化结构

- ✅ 后端采用分层架构（Router-Service-Model）
- ✅ 前端组件化设计（Components-Services-Hooks）
- ✅ 更好的代码组织和可维护性
- ✅ 更强的可扩展性

详见 [重构说明文档](REFACTORING.md)
